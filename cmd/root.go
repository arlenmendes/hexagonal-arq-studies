...
import (
	"database/sql"
	dbinfra "github/arlenmendes/hexagonal-arq-studies/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hexagonal-arq-studies.yaml)")
